...
class DogBreedsListRouter: DogBreedsListRoutingLogic, DogBreedsListDataPassing {
  ...
  //func navigateToSomewhere(source: DogBreedListViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: DogBreedListDataStore, destination: inout SomewhereDataStore)
  //{
